...
Let's look at some examples xxx
...
- A study that investigated the relationship between religiosity and
  ...
  ovulating" or it might conclude that "Catholic women become more
  religious when ovulating". If you do the study
...
both be a replication and an extension.
